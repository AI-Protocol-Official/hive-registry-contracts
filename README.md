# AI Protocol Hive Registry Contracts #
...
* Smart Contract(s):
    * [HiveRegistryV1](contracts/bonding_curves/HiveRegistryV1.sol) – Hive Restry V1 implementation
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/hive-registry-contracts.git```
2. Navigate into the cloned repository  
    ```cd hive-registry-contracts```
